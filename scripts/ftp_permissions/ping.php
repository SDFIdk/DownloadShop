...
// drush scr --root=/home/drupal/kms.live/site/htdocs /home/drupal/kms.live/site/scripts/ftp_permissions/ping.php
...
if (variable_get('kms_ftp_perm_change')){
  ...
  foreach($ftp_script_hosts as $host) {
    ...
    var_dump(sprintf('ssh -i  $HOME/.ssh/updateftpservers %s', $host));
    $wd_msg[] = $message;
  }
  ...
  watchdog('Permissions FTP', 'Ftp cron script ran with messages: @messages', array('@messages' => implode(', ' $wd_msg)), WATCHDOG_NOTICE);
}